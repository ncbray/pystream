...
def isGLSL(filename):
	return len(filename) > len(glslFiles) and filename[:len(glslFiles)] == glslFiles

glslFiles = 'C:\\projects\\pystream\\bin\\shader'
...
def contextStats(name, prgm, classOK=False):
